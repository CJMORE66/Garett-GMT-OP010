# Důkazní balíček: `PartDataManage`

## FAKTA

- Objekt: `PartDataManage`
- Druh: `SW.Blocks.FB`
- Číslo: `2`
- Jazyk: `SCL`
- Deklarace (export): `EXPORT/Program blocks/03_Device/104 PartDataManage/PartDataManage.xml`
- Riziko: `RIZIKOVÉ`
...
- Nálezy `CallInfo Name="PartDataManage"`: `0`
- Nálezy `Text="PartDataManage"` (tokenizovaný StructuredText): `0`
- Nálezy `Component Name="PartDataManage"`: `0`

### Volání bloků (z `deep_reader/out/call_edges.csv`)

- Příchozí volání (kdo volá `PartDataManage`): `0`
- Odchozí volání (co `PartDataManage` volá): `0`
