...
- Číslo: `1080`
- Jazyk: `SCL`
- Deklarace (export): `EXPORT/Program blocks/OP010/10_Device/08_PressureAanlog/ST10_Analog.xml`
- Riziko: `RIZIKOVÉ`
...
- Nálezy `CallInfo Name="ST10_Analog"`: `0`
- Nálezy `Text="ST10_Analog"` (tokenizovaný StructuredText): `0`
- Nálezy `Component Name="ST10_Analog"`: `0`

### Volání bloků (z `deep_reader/out/call_edges.csv`)

- Příchozí volání (kdo volá `ST10_Analog`): `0`
- Odchozí volání (co `ST10_Analog` volá): `0`
