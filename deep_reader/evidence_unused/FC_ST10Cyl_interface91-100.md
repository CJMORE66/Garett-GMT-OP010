# Důkazní balíček: `ST10Cyl_interface91-100`

## FAKTA

- Objekt: `ST10Cyl_interface91-100`
- Druh: `SW.Blocks.FC`
- Číslo: `1029`
- Jazyk: `LAD`
- Deklarace (export): `EXPORT/Program blocks/OP010/10_Device/01_Cylinder/ST10Cyl_interface91-100.xml`
- Riziko: `RIZIKOVÉ`
...
- Nálezy `CallInfo Name="ST10Cyl_interface91-100"`: `0`
- Nálezy `Text="ST10Cyl_interface91-100"` (tokenizovaný StructuredText): `0`
- Nálezy `Component Name="ST10Cyl_interface91-100"`: `0`

### Volání bloků (z `deep_reader/out/call_edges.csv`)

- Příchozí volání (kdo volá `ST10Cyl_interface91-100`): `0`
- Odchozí volání (co `ST10Cyl_interface91-100` volá): `0`
