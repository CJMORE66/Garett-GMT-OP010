...
- Číslo: `4080`
- Jazyk: `SCL`
- Deklarace (export): `EXPORT/Program blocks/03_Device/211 ATEQ LeakTest/FB_AteqF620.xml`
- Riziko: `RIZIKOVÉ`
...
- Nálezy `CallInfo Name="FB_AteqF620"`: `0`
- Nálezy `Text="FB_AteqF620"` (tokenizovaný StructuredText): `0`
- Nálezy `Component Name="FB_AteqF620"`: `0`

### Volání bloků (z `deep_reader/out/call_edges.csv`)

- Příchozí volání (kdo volá `FB_AteqF620`): `0`
- Odchozí volání (co `FB_AteqF620` volá): `0`
