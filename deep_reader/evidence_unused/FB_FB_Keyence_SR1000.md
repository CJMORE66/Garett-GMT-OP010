# Důkazní balíček: `FB_Keyence_SR1000`

## FAKTA

- Objekt: `FB_Keyence_SR1000`
- Druh: `SW.Blocks.FB`
- Číslo: `1230`
- Jazyk: `SCL`
- Deklarace (export): `EXPORT/Program blocks/03_Device/214_KeyenceSR X80/FB_Keyence_SR1000.xml`
- Riziko: `RIZIKOVÉ`
...
- Nálezy `CallInfo Name="FB_Keyence_SR1000"`: `0`
- Nálezy `Text="FB_Keyence_SR1000"` (tokenizovaný StructuredText): `0`
- Nálezy `Component Name="FB_Keyence_SR1000"`: `0`

### Volání bloků (z `deep_reader/out/call_edges.csv`)

- Příchozí volání (kdo volá `FB_Keyence_SR1000`): `0`
- Odchozí volání (co `FB_Keyence_SR1000` volá): `0`
