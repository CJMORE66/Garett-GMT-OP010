# Důkazní balíček: `ST10_SafetyGate`

## FAKTA

- Objekt: `ST10_SafetyGate`
- Druh: `SW.Blocks.FC`
- Číslo: `1140`
- Jazyk: `SCL`
- Deklarace (export): `EXPORT/Program blocks/OP010/10_Device/03_SafetyGate/ST10_SafetyGate.xml`
...
- Nálezy `CallInfo Name="ST10_SafetyGate"`: `0`
- Nálezy `Text="ST10_SafetyGate"` (tokenizovaný StructuredText): `0`
- Nálezy `Component Name="ST10_SafetyGate"`: `0`

### Volání bloků (z `deep_reader/out/call_edges.csv`)

- Příchozí volání (kdo volá `ST10_SafetyGate`): `0`
- Odchozí volání (co `ST10_SafetyGate` volá): `0`
...
- Důvod (registr NEŠAHAT): Bezpečnostně-adjacentní klíčová slova: safe, safety
- Klíčová slova: safe, safety
