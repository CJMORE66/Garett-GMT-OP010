...
- Číslo: `3002`
- Jazyk: `SCL`
- Deklarace (export): `EXPORT/Program blocks/02_Comm/04-ChangeOver/ChangeOver.xml`
- Riziko: `RIZIKOVÉ`
...
- Nálezy `CallInfo Name="ChangeOver"`: `0`
- Nálezy `Text="ChangeOver"` (tokenizovaný StructuredText): `0`
- Nálezy `Component Name="ChangeOver"`: `0`

### Volání bloků (z `deep_reader/out/call_edges.csv`)

- Příchozí volání (kdo volá `ChangeOver`): `0`
- Odchozí volání (co `ChangeOver` volá): `0`
