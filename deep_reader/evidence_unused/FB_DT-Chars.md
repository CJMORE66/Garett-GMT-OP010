...
- Číslo: `2360`
- Jazyk: `SCL`
- Deklarace (export): `EXPORT/Program blocks/OP010/11_MES/DT-Chars.xml`
...
- Nálezy `CallInfo Name="DT-Chars"`: `0`
- Nálezy `Text="DT-Chars"` (tokenizovaný StructuredText): `0`
- Nálezy `Component Name="DT-Chars"`: `0`

### Volání bloků (z `deep_reader/out/call_edges.csv`)

- Příchozí volání (kdo volá `DT-Chars`): `0`
- Odchozí volání (co `DT-Chars` volá): `0`
