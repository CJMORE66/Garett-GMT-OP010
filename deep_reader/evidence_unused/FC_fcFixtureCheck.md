# Důkazní balíček: `fcFixtureCheck`

## FAKTA

- Objekt: `fcFixtureCheck`
- Druh: `SW.Blocks.FC`
- Číslo: `2`
- Jazyk: `LAD`
- Deklarace (export): `EXPORT/Program blocks/03_Device/100 FixtureCheck/fcFixtureCheck.xml`
- Riziko: `RIZIKOVÉ`
...
- Nálezy `CallInfo Name="fcFixtureCheck"`: `0`
- Nálezy `Text="fcFixtureCheck"` (tokenizovaný StructuredText): `0`
- Nálezy `Component Name="fcFixtureCheck"`: `0`

### Volání bloků (z `deep_reader/out/call_edges.csv`)

- Příchozí volání (kdo volá `fcFixtureCheck`): `0`
- Odchozí volání (co `fcFixtureCheck` volá): `0`
