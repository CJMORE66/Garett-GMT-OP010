...
- Číslo: `4090`
- Jazyk: `LAD`
- Deklarace (export): `EXPORT/Program blocks/03_Device/212 Analog/FB_Analog.xml`
- Riziko: `RIZIKOVÉ`
...
- Nálezy `CallInfo Name="FB_Analog"`: `0`
- Nálezy `Text="FB_Analog"` (tokenizovaný StructuredText): `0`
- Nálezy `Component Name="FB_Analog"`: `0`

### Volání bloků (z `deep_reader/out/call_edges.csv`)

- Příchozí volání (kdo volá `FB_Analog`): `0`
- Odchozí volání (co `FB_Analog` volá): `0`
