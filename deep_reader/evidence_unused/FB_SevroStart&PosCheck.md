# Důkazní balíček: `SevroStart&PosCheck`

## FAKTA

- Objekt: `SevroStart&PosCheck`
- Druh: `SW.Blocks.FB`
- Číslo: `4073`
- Jazyk: `LAD`
- Deklarace (export): `EXPORT/Program blocks/OP010/10_Device/25_V90/V90_Standard/ServoCheck/SevroStart&PosCheck.xml`
- Riziko: `RIZIKOVÉ`
...
- Nálezy `CallInfo Name="SevroStart&PosCheck"`: `0`
- Nálezy `Text="SevroStart&PosCheck"` (tokenizovaný StructuredText): `0`
- Nálezy `Component Name="SevroStart&PosCheck"`: `0`

### Volání bloků (z `deep_reader/out/call_edges.csv`)

- Příchozí volání (kdo volá `SevroStart&PosCheck`): `0`
- Odchozí volání (co `SevroStart&PosCheck` volá): `0`
