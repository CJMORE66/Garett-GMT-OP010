...
- Číslo: `1`
- Jazyk: `LAD`
- Deklarace (export): `EXPORT/Program blocks/OP010/10_Device/25_V90/Patch/块_1.xml`
- Riziko: `RIZIKOVÉ`
...
- Nálezy `CallInfo Name="块_1"`: `0`
- Nálezy `Text="块_1"` (tokenizovaný StructuredText): `0`
- Nálezy `Component Name="块_1"`: `0`

### Volání bloků (z `deep_reader/out/call_edges.csv`)

- Příchozí volání (kdo volá `块_1`): `0`
- Odchozí volání (co `块_1` volá): `0`
