# Důkazní balíček: `CheckPositioningOrder`

## FAKTA

- Objekt: `CheckPositioningOrder`
- Druh: `SW.Blocks.FB`
- Číslo: `1`
- Jazyk: `LAD`
- Deklarace (export): `EXPORT/Program blocks/OP010/10_Device/25_V90/Patch/CheckPositioningOrder.xml`
- Riziko: `RIZIKOVÉ`
...
- Nálezy `CallInfo Name="CheckPositioningOrder"`: `0`
- Nálezy `Text="CheckPositioningOrder"` (tokenizovaný StructuredText): `0`
- Nálezy `Component Name="CheckPositioningOrder"`: `0`

### Volání bloků (z `deep_reader/out/call_edges.csv`)

- Příchozí volání (kdo volá `CheckPositioningOrder`): `0`
- Odchozí volání (co `CheckPositioningOrder` volá): `0`
