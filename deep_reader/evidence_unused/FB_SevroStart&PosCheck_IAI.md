# Důkazní balíček: `SevroStart&PosCheck_IAI`

## FAKTA

- Objekt: `SevroStart&PosCheck_IAI`
- Druh: `SW.Blocks.FB`
- Číslo: `2209`
- Jazyk: `LAD`
- Deklarace (export): `EXPORT/Program blocks/OP010/10_Device/22_IAI/ServoCheck/SevroStart&PosCheck_IAI.xml`
- Riziko: `RIZIKOVÉ`
...
- Nálezy `CallInfo Name="SevroStart&PosCheck_IAI"`: `0`
- Nálezy `Text="SevroStart&PosCheck_IAI"` (tokenizovaný StructuredText): `0`
- Nálezy `Component Name="SevroStart&PosCheck_IAI"`: `0`

### Volání bloků (z `deep_reader/out/call_edges.csv`)

- Příchozí volání (kdo volá `SevroStart&PosCheck_IAI`): `0`
- Odchozí volání (co `SevroStart&PosCheck_IAI` volá): `0`
