# Důkazní balíček: `OP010_MES_RecipeDB`

## FAKTA

- Objekt: `OP010_MES_RecipeDB`
- Druh: `SW.Blocks.GlobalDB`
- Číslo: `9`
- Jazyk: `DB`
- Deklarace (export): `EXPORT/Program blocks/OP010/08_ChangeOver/MES/OP010_MES_RecipeDB.xml`
...
- Nálezy `CallInfo Name="OP010_MES_RecipeDB"`: `0`
- Nálezy `Text="OP010_MES_RecipeDB"` (tokenizovaný StructuredText): `0`
- Nálezy `Component Name="OP010_MES_RecipeDB"`: `0`

### Volání bloků (z `deep_reader/out/call_edges.csv`)

- Příchozí volání (kdo volá `OP010_MES_RecipeDB`): `0`
- Odchozí volání (co `OP010_MES_RecipeDB` volá): `0`
...
- Root `OP010_MES_RecipeDB` nebyl nalezen v symbolickém použití (0 záznamů).

### Absolutní adresování DB (orientační scan)

- Pro DB číslo `9` nebyl nalezen výskyt `DB9` / `DB 9` v exportovaných OB/FB/FC (není to důkaz nepoužití).

### Vazby HMI (z `deep_reader/out/hmi_tags.csv`)

- HMI tagy s kořenem `ControllerTag` = `OP010_MES_RecipeDB`: `0`
