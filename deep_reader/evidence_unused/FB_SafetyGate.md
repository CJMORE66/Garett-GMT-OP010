...
- Číslo: `5200`
- Jazyk: `LAD`
- Deklarace (export): `EXPORT/Program blocks/03_Device/102 SafetyGate/SafetyGate.xml`
...
- Nálezy `CallInfo Name="SafetyGate"`: `0`
- Nálezy `Text="SafetyGate"` (tokenizovaný StructuredText): `0`
- Nálezy `Component Name="SafetyGate"`: `0`

### Volání bloků (z `deep_reader/out/call_edges.csv`)

- Příchozí volání (kdo volá `SafetyGate`): `0`
- Odchozí volání (co `SafetyGate` volá): `0`
