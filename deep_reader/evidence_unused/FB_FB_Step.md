...
- Číslo: `5002`
- Jazyk: `LAD`
- Deklarace (export): `EXPORT/Program blocks/03_Device/999 Base/FB_Step.xml`
- Riziko: `RIZIKOVÉ`
...
- Nálezy `CallInfo Name="FB_Step"`: `0`
- Nálezy `Text="FB_Step"` (tokenizovaný StructuredText): `0`
- Nálezy `Component Name="FB_Step"`: `0`

### Volání bloků (z `deep_reader/out/call_edges.csv`)

- Příchozí volání (kdo volá `FB_Step`): `0`
- Odchozí volání (co `FB_Step` volá): `0`
