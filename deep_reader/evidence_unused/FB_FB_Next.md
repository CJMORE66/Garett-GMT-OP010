...
- Číslo: `42`
- Jazyk: `SCL`
- Deklarace (export): `EXPORT/Program blocks/03_Device/999 Base/999.0 General/999.0.3 FB/FB_Next.xml`
- Riziko: `RIZIKOVÉ`
...
- Nálezy `CallInfo Name="FB_Next"`: `0`
- Nálezy `Text="FB_Next"` (tokenizovaný StructuredText): `0`
- Nálezy `Component Name="FB_Next"`: `0`

### Volání bloků (z `deep_reader/out/call_edges.csv`)

- Příchozí volání (kdo volá `FB_Next`): `0`
- Odchozí volání (co `FB_Next` volá): `0`
