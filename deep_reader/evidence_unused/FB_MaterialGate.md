...
- Číslo: `5210`
- Jazyk: `LAD`
- Deklarace (export): `EXPORT/Program blocks/03_Device/102 SafetyGate/MaterialGate.xml`
...
- Nálezy `CallInfo Name="MaterialGate"`: `0`
- Nálezy `Text="MaterialGate"` (tokenizovaný StructuredText): `0`
- Nálezy `Component Name="MaterialGate"`: `0`

### Volání bloků (z `deep_reader/out/call_edges.csv`)

- Příchozí volání (kdo volá `MaterialGate`): `0`
- Odchozí volání (co `MaterialGate` volá): `0`
