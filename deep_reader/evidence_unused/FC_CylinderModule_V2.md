# Důkazní balíček: `CylinderModule_V2`

## FAKTA

- Objekt: `CylinderModule_V2`
- Druh: `SW.Blocks.FC`
- Číslo: `3010`
- Jazyk: `LAD`
- Deklarace (export): `EXPORT/Program blocks/03_Device/101_Cylinder/CylinderModule_V2.xml`
- Riziko: `RIZIKOVÉ`
...
- Nálezy `CallInfo Name="CylinderModule_V2"`: `0`
- Nálezy `Text="CylinderModule_V2"` (tokenizovaný StructuredText): `0`
- Nálezy `Component Name="CylinderModule_V2"`: `0`

### Volání bloků (z `deep_reader/out/call_edges.csv`)

- Příchozí volání (kdo volá `CylinderModule_V2`): `0`
- Odchozí volání (co `CylinderModule_V2` volá): `0`
