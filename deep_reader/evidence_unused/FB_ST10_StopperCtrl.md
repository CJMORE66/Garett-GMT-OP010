# Důkazní balíček: `ST10_StopperCtrl`

## FAKTA

- Objekt: `ST10_StopperCtrl`
- Druh: `SW.Blocks.FB`
- Číslo: `2601`
- Jazyk: `LAD`
- Deklarace (export): `EXPORT/Program blocks/OP010/10_Device/26_Stopper/ST10_StopperCtrl.xml`
...
- Nálezy `CallInfo Name="ST10_StopperCtrl"`: `0`
- Nálezy `Text="ST10_StopperCtrl"` (tokenizovaný StructuredText): `0`
- Nálezy `Component Name="ST10_StopperCtrl"`: `0`

### Volání bloků (z `deep_reader/out/call_edges.csv`)

- Příchozí volání (kdo volá `ST10_StopperCtrl`): `0`
- Odchozí volání (co `ST10_StopperCtrl` volá): `1`
- Seznam volaných (vzorek):
  - `StopperCtrl` (SW.Blocks.FB, `LAD`) `EXPORT/Program blocks/OP010/10_Device/26_Stopper/01_FuncationBlock/StopperCtrl.xml`
